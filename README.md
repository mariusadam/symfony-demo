...
To have a running mysql instance run
```
sudo docker run --name symfony_demo_mysql -p 3306:3306 -e MYSQL_ROOT_PASSWORD=root -e MYSQL_DATABASE=symfony_demo_blog -v "${PWD}/var/data/mysql":/var/lib/mysql -v "${PWD}/my.cnf":/etc/mysql/my.cnf -d mysql:5.7
```
